...
ReminderDialog::ReminderDialog(const QString& taskName, const QString& startTime,
                               const QString& dueIn, int numberOfRem,
                               const QString& username, const QString& created, QWidget *parent) :
    QDialog(parent)
{
    inputs = std::make_tuple(taskName,startTime,dueIn,numberOfRem,username,created);
    ...
    setWindowTitle(QString("Reminder %1 - ")
                   .arg(std::get<3>(inputs)) + QApplication::applicationName());
    resize(400,200);
    show();
}
...
void ReminderDialog::createWidgets() {
    ...
    taskNameLabel = new QLabel(tr("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                                  "<b><font color = '#006699'>Task name:&nbsp;&nbsp;&nbsp;</font></b>" +
                                  std::get<0>(inputs).toLatin1()),this);
    taskNameLabel->setTextFormat(Qt::RichText);
    startTimeLabel = new QLabel(tr("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                                      "<b><font color = '#006699'>Start time:&nbsp;&nbsp;&nbsp;</font></b>" +
                                      std::get<1>(inputs).toLatin1()),this);
    startTimeLabel->setTextFormat(Qt::RichText);
    dueTimeLabel = new QLabel(tr("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                                    "<b><font color = '#006699'>Due in:&nbsp;&nbsp;&nbsp;</font></b>" +
                                    std::get<2>(inputs).toLatin1()),this);
...
void ReminderDialog::createConnections() {
    connect(dismissButton, SIGNAL(clicked()),
            this, SLOT(dismissDialog()));
    connect(snoozeButton, SIGNAL(clicked()),
            this, SLOT(snoozeTask()));
...
void ReminderDialog::snoozeTask() {
    emit snooze(std::get<4>(inputs), std::get<5>(inputs), snoozeBox->currentText());
    timer->stop();
    close();
}
...
void ReminderDialog::populateCombobox() {
    ...
    QDateTime dueTime = QDateTime::fromString(std::get<1>(inputs),"d.M.yyyy hh.mm");
